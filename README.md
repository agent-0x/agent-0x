...
╔═══════════════════════════════════════════════════════════════╗
║                                                               ║
║              D O S S I E R  —  agent-0x                       ║
║              CLASSIFICATION: O P E N  S O U R C E             ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝
```
...
| Operation | Codename | Brief |
|:---------:|----------|-------|
| 🔁 | **[claude-recall](https://github.com/agent-0x/claude-recall)** | Turn repetitive Claude Code workflows into reusable skills — zero config, zero deps |
| 🔍 | **[claude-codex-review](https://github.com/agent-0x/claude-codex-review)** | Dual-AI code review loop: Codex hunts bugs, Claude patches — repeat until clean |
| ⏱️ | **[ai-time-saved](https://github.com/agent-0x/ai-time-saved)** | Estimate human vs AI time after completing coding tasks |
...
```
> connection closed. eyes everywhere.
```
